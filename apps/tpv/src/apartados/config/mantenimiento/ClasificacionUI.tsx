...
// El color, la foto y el icono se eligen en la ventana `AspectoClasificacion`
// (mismo gesto que en el artículo); aquí solo queda la paleta que esa ventana
// reutiliza y el interruptor.
