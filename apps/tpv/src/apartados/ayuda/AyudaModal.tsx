...
// Modal de "Ayuda y soporte técnico" (del diseño gluuh-inicio-diseño.html): vías
// de contacto directas para cuando el bar está parado. Los datos concretos
...
export function AyudaModal({ licencia, terminal, version, onCerrar }: Readonly<{ licencia: string; terminal: string; version: string; onCerrar: () => void }>) {
  return (
    <Modal onCerrar={onCerrar} ancho="xl" className="p-8">
