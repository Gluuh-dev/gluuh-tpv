...
import type { EstadoPreparacion, TipoOperacion } from "@gluuh/core";
...
const g = globalThis as unknown as { __gluuhPedidos?: Store };
const store: Store = g.__gluuhPedidos ?? { pedidos: [], siguienteNumero: 1 };
g.__gluuhPedidos = store;
