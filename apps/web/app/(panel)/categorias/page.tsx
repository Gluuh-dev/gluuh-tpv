...
// Listado de CATEGORÍAS sobre TablaDatos (barra Nuevo/Duplicar/Editar/Eliminar +
// buscador). Color propio de la categoría (0066) con herencia del de la familia.
    ...
    <div className="flex h-full min-h-0 flex-col gap-4">
      ...
      {!loading && filas.length === 0 ? (
        ...
        <TablaDatos
          ...
          filas={filas}
          idDe={(f) => f.id}
          onNuevo={() => router.push("/categorias/nuevo")}
