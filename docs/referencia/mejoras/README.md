...
1. **Dos niveles de interfaz, una sola base de código.**
   ...
   - Ver [20 — Guía de diseño](../../especificaciones/guia-de-diseno.md) y [01 §1.1 — el binomio](../01-arquitectura-y-plataforma/).
...
> Cada documento sigue el patrón: **Para qué sirve · Cómo lo hace Ágora · Cómo lo mejoramos (nuestro estilo + más intuitivo) · Prioridad**. El **cómo construirlo** va en [`../implementacion/`](../diseno/).
