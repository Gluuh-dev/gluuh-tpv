...
> [`docs/dossier/13-roadmap-mvp-y-equipo.md`](../../dossier/13-roadmap-mvp-y-equipo.md) (visión MVP/equipo/coste) y
> las [guías ejecutables de `docs/implementacion/`](../../implementacion/README.md) (el *cómo* vigente,
> frente a frente). Aquí priorizamos sobre el **estado real del repo**: `apps/web` está muy avanzada,
...
> Documentos relacionados: [13 · Roadmap, MVP y equipo](../../dossier/13-roadmap-mvp-y-equipo.md) ·
> [Guías de implementación vigentes](../../implementacion/README.md) ·
