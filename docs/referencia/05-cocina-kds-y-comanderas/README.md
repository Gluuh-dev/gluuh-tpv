...
> **flujo en tiempo real**. Profundiza y referencia [10 — Comanderas, KDS e impresión](../../dossier/10-comanderas-kds-e-impresion.md),
> [14 — Pantallas: kiosko, KDS, display y ofertas](../../dossier/14-pantallas-cliente-kiosko-y-kds.md) y
> [09 — Hardware](../../dossier/09-hardware.md).
>
...
> [10 §3](../../dossier/10-comanderas-kds-e-impresion.md) y el hardware en [09 §3](../../dossier/09-hardware.md).
...
> Detalle, modelos y precios en [09 — Hardware](../../dossier/09-hardware.md).
