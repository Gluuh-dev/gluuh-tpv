...
> La pantalla "Acerca de" revela el **modelo de licencia** de Ágora y su **catálogo de módulos/add‑ons** — útil como mapa de funcionalidades y referencia para **nuestro modelo de negocio** ([11 — Modelo de negocio y precios](../../dossier/11-modelo-de-negocio-y-precios.md)).
...
- **Declaración responsable VERIFACTU**: documento legal que el fabricante del software debe ofrecer (cumplimiento). **Nosotros también** debemos generar esa declaración — anotar en [07 — Facturación](../../dossier/07-facturacion-y-cumplimiento-legal.md).
