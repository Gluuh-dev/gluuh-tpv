...
> Medios de cobro (Efectivo, Tarjeta, Transferencia, AgoraPay, vales…), cada uno con un comportamiento configurable: si abre cajón, da cambio, entra en arqueo, registra propina, usa pasarela, etc. Alimenta el cobro del TPV y el cuadre de caja. Ver [08 — Pasarelas de pago](../../../dossier/08-pasarelas-de-pago.md).
