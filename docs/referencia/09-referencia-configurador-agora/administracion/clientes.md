...
- **RGPD de serie**: el flag *Enviar Publicidad* con fecha/origen de consentimiento y export/borrado del cliente (ver [12 — Seguridad y RGPD](../../../dossier/12-seguridad-y-rgpd.md)).
