...
- Export server‑side del catálogo/inventario filtrable por almacén/familia/categoría a **Excel/CSV** (y reimport para inventario, ver [inventario.md](../compras-stocks/inventario.md)).
