...
> Configuración del emisor **VERIFACTU** (certificado mTLS, NIF) y **visor de facturas** emitidas con verificación de la **cadena de huellas**. Es nuestro **diferenciador** y ya existe parcialmente en el repo (`@gluuh/core` motor + *Visor Verifactu* en `apps/web`, commit reciente). Ver [07 — Facturación y cumplimiento legal](../../../dossier/07-facturacion-y-cumplimiento-legal.md).
