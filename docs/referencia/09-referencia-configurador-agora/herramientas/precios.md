...
> Recalcula el **PVP a partir del coste y un margen objetivo** (food cost %), mostrando antiguo vs nuevo antes de aplicar. Liga con el escandallo/coste ([almacenes.md](../compras-stocks/almacenes.md), [06](../../06-compras-proveedores-e-inventario/)). Operación de actualización masiva sobre `product_price`.
