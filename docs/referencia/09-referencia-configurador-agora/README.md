...
>
> Documento **vivo**: se completa según se reciben capturas. Cada ficha enlaza con **[07 — Configuración y administración](../07-configuracion-y-administracion/)** (modelo de datos de config) y con la fiscalidad **[../07-facturacion-y-cumplimiento-legal.md](../../dossier/07-facturacion-y-cumplimiento-legal.md)**.
