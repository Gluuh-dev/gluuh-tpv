...
> [`../implementacion/arquitectura.md`](../diseno/arquitectura.md) §4 (hardware) y §2 (sync),
> y [`../implementacion/conexion-y-roles-dispositivo.md`](../diseno/conexion-y-roles-dispositivo.md).
...
1. **Hablar con hardware físico** — impresora térmica ESC/POS (RAW :9100, USB, serie, Bluetooth),
   ...
   plataformas) y [`../implementacion/arquitectura.md` §4](../diseno/arquitectura.md).
...
[`../implementacion/conexion-y-roles-dispositivo.md`](../diseno/conexion-y-roles-dispositivo.md)).
...
ver [`../implementacion/arquitectura.md` §4.1](../diseno/arquitectura.md)). **Abstracción
...
|---|---|---|---|
| **`Printer`** | ESC/POS (Epson/Star/Sunmi) | red **:9100** RAW · USB · serie · BT Sunmi · ePOS · CloudPRNT | [`arquitectura.md §4.2`](../diseno/arquitectura.md) |
...
| **`Scale`** (balanza) | balanza HID/serie | HID · serie | [`arquitectura.md §4`](../diseno/arquitectura.md) |
...
- **Reintentos con backoff** y **estado de impresora** (online / sin papel / offline) reportado a la
  ...
  comandas (ver [`../implementacion/arquitectura.md` §4.2](../diseno/arquitectura.md)).
...
- **Cache + coherencia entre terminales sin internet**: hospeda una instancia local de
  ...
  móvil al KDS por Ethernet aunque caiga la fibra** ([`arquitectura.md §2.2`](../diseno/arquitectura.md)).
- **Eventos efímeros** ("nueva comanda", "mesa lista", bump) por **Socket.IO en LAN**; los **datos
  ...
  [`arquitectura.md §2.3`](../diseno/arquitectura.md)).
...
no cobrar/numerar dos veces tras reconexión ([`arquitectura.md §2.1`](../diseno/arquitectura.md)).
...
- **Token de nodo, no la contraseña.** El servicio se autentica ante la nube con un token de larga
  ...
  [`conexion-y-roles-dispositivo.md §6`](../diseno/conexion-y-roles-dispositivo.md).
...
Ágora — [`conexion-y-roles-dispositivo.md`](../diseno/conexion-y-roles-dispositivo.md)).
...
- **Emparejamiento inicial del terminal**: por **QR del backoffice** (tenant + rol + token), como ya
  define [`conexion-y-roles-dispositivo.md §2`](../diseno/conexion-y-roles-dispositivo.md);
...
- **Salud / heartbeat.** El servicio reporta a la nube `online`, versión, estado de cada periférico
  ...
  ([`arquitectura.md §3.2`](../diseno/arquitectura.md)).
...
- **Actualización automática.** Auto-update **firmado** (como el TPV Tauri,
  [`arquitectura.md §8`](../diseno/arquitectura.md)); descarga, verifica firma, reinicia el
...
- **Secretos protegidos.** El **certificado mTLS VERIFACTU** y las **claves de pasarela** **nunca
  tocan el cliente ni el nodo**: viven solo en `apps/api` ([`arquitectura.md §3.1/§7`](../diseno/arquitectura.md));
...
*[`../implementacion/arquitectura.md`](../diseno/arquitectura.md) ·*
*[`../implementacion/conexion-y-roles-dispositivo.md`](../diseno/conexion-y-roles-dispositivo.md) ·*
