...
"equipo maestro" de Ágora ([conexión y roles](../diseno/conexion-y-roles-dispositivo.md))
...
- **Dispositivo → token de dispositivo (QR).** Como ya describe
  [conexión y roles de dispositivo](../diseno/conexion-y-roles-dispositivo.md): el terminal
...
- **RGPD.** Datos personales de empleados (NIF, NSS, contacto) y clientes con **base legal**,
  ...
  cambio de rol). Ver [12 — Seguridad y RGPD](../../dossier/12-seguridad-y-rgpd.md).
...
[conexión y roles de dispositivo](../diseno/conexion-y-roles-dispositivo.md) ·
[implementación (README)](../diseno/README.md)
