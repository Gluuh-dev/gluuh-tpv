...
> [09 — Hardware](../../dossier/09-hardware.md) (modelos, precios) ya cubren, y mapea a la entidad
...
> y [09 §2‑3](../../dossier/09-hardware.md).

**Qué necesitamos** · implementar en `packages/hardware` un `Transport` por `via` detrás de
la interfaz `Printer` existente; reserva DHCP por impresora ([09 §8](../../dossier/09-hardware.md)).
...
> ver [conexión y roles de dispositivo](../diseno/conexion-y-roles-dispositivo.md).
...
[conexión y roles de dispositivo](../diseno/conexion-y-roles-dispositivo.md); los
...
- [09 — Hardware](../../dossier/09-hardware.md) §2‑3 (impresoras, cocina/KDS), §5 (cajón RJ11), §8
  (red, IP fijas).
...
- [Conexión y roles de dispositivo](../diseno/conexion-y-roles-dispositivo.md) —
