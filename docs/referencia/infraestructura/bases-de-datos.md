...
- `@gluuh/core` corre **aquí**: calcula la huella SHA-256 encadenada y el QR VERIFACTU **sin red** → el ticket sale impreso al instante (ver §6 y [`../implementacion/arquitectura.md`](../diseno/arquitectura.md) §3).
...
La sincronización **no se construye a mano**. Es el riesgo número uno del proyecto y **PowerSync** lo resuelve (ver regla nº1 en [`../../dossier/06-base-de-datos-y-sincronizacion.md`](../../dossier/06-base-de-datos-y-sincronizacion.md) §7).
...
- **Cómo lo resolvemos:** **dos capas separadas** (ver [`../implementacion/arquitectura.md`](../diseno/arquitectura.md) §2.3):
...
Modelo: **shared schema + columna `tenant_id` + RLS**. El aislamiento vive **en la base, no en el cliente** (ver [`../../dossier/06-base-de-datos-y-sincronizacion.md`](../../dossier/06-base-de-datos-y-sincronizacion.md) §2 y [`../implementacion/modelo-de-datos.md`](../diseno/modelo-de-datos.md) §0).
...
- **Secretos fuera del repo y del cliente:** `.env*` en `.gitignore`; solo `.env.example` versionado. Service-role de Supabase, claves de pasarela y certificado AEAT **solo en `apps/api`/agente** (ver [`../implementacion/arquitectura.md`](../diseno/arquitectura.md) §7).
...
*[`../implementacion/modelo-de-datos.md`](../diseno/modelo-de-datos.md) · [`../implementacion/arquitectura.md`](../diseno/arquitectura.md) ·*
*[`../01-arquitectura-y-plataforma/`](../01-arquitectura-y-plataforma/) · [`../../dossier/06-base-de-datos-y-sincronizacion.md`](../../dossier/06-base-de-datos-y-sincronizacion.md).*
