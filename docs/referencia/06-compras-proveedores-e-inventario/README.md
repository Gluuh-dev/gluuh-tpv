...
> [carpeta 03 — Catálogo de productos](../03-catalogo-productos-y-modificadores/README.md); aquí **no se
> redefine**, se referencia y se extiende con la cara de aprovisionamiento. Requisitos de
> producto en [`docs/dossier/03-requisitos-funcionales.md`](../../dossier/03-requisitos-funcionales.md)
