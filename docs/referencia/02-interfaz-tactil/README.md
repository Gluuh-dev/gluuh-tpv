...
> Para la estética base ver [`20-guia-de-diseno.md`](../../especificaciones/guia-de-diseno.md) y para el
> inventario de pantallas cliente/cocina [`14-pantallas-cliente-kiosko-y-kds.md`](../../dossier/14-pantallas-cliente-kiosko-y-kds.md).
...
[`14 §5`](../../dossier/14-pantallas-cliente-kiosko-y-kds.md).
...
- Sin interacción (es señalización); coherente en tiempo real con KDS y kiosko (mismo estado en BD,
  Supabase Realtime en producción — ver [`14 §9`](../../dossier/14-pantallas-cliente-kiosko-y-kds.md)).
- El **kiosko** (`/kiosko`) es vertical, autoservicio, botones aún más grandes, fotos/emojis, y debe
  bloquear gestos de navegación del navegador (modo kiosko). Ver [`14 §4`](../../dossier/14-pantallas-cliente-kiosko-y-kds.md).
