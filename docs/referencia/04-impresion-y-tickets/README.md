...
> columnas. Profundiza en lo que [09 — Hardware](../../dossier/09-hardware.md) y
> [10 — Comanderas, KDS e impresión](../../dossier/10-comanderas-kds-e-impresion.md) introducen.
...
- [09 — Hardware](../../dossier/09-hardware.md) §2–3, §5 (impresoras, cajón RJ11, KDS).
- [10 — Comanderas, KDS e impresión](../../dossier/10-comanderas-kds-e-impresion.md) §3 (vías ESC/POS) y §4 (formatos).
- [07 — Facturación y cumplimiento legal](../../dossier/07-facturacion-y-cumplimiento-legal.md) (VERIFACTU, QR).
