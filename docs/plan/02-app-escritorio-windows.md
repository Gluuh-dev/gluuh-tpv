...
decidido frente a Tauri (`docs/dossier/05-stack-tecnologico.md`) precisamente por el ecosistema
...
- Numeración fiscal offline por **rangos por dispositivo** (ya diseñado en
  `docs/dossier/06-base-de-datos-y-sincronizacion.md`) — requiere la pieza 2 (identidad).
...
- **Un solo canal de hardware: el preload.** Nada de servicios Windows aparte ni
  procesos locales con API HTTP (la carpeta `docs/referencia/infraestructura/` menciona
