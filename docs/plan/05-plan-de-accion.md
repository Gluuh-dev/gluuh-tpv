...
F0–F8 de `docs/referencia/diseno/plan-por-fases.md`.
...
estado. Ya diseñado en `docs/referencia/diseno/modelo-de-datos.md`.
...
- **Compras/stock completo**: el mayor hueco funcional contra Ágora (docs/especificaciones/mapa-agora-completo.md); todo
  el diseño está en `docs/referencia/`. Es un producto en sí mismo — no colarlo antes
  que P0/P1.
