...
`docs/dossier/01-investigacion-mercado.md`); Ágora sigue siendo la referencia funcional completa
(`docs/especificaciones/mapa-agora-completo.md`). Este doc se centra en la **pantalla de venta**, que
...
| **Tarifa activa** (precio por tarifa/horario) | ❌ | `tarifa` es stub sin precios. Necesita `product_price` por tarifa + programación horaria (ya identificado en docs/referencia) |
...
- **Su estética 2010** (verde flúo, bordes duros, densidad caótica). Mantenemos la
  ...
  (`tenant_branding` ya funciona), backoffice estilo Supabase (`docs/especificaciones/guia-de-diseno.md`).
