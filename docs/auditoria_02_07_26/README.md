...
> Esta auditoría **actualiza y complementa** la de junio (`docs/auditoria/`, 19-06-2026).
...
- `docs/auditoria/` — auditoría exhaustiva de junio (referencia Ágora, modelo de datos objetivo ~1.400 líneas, plan F0–F8).
- `docs/05-stack-tecnologico.md` — decisión de stack (Electron ya elegido sobre Tauri).
- `docs/18-mapa-agora-completo.md` — checklist funcional contra Ágora.
- `docs/GUIA_DISENO_COMPLETA.md` — sistema de diseño (backoffice estilo Supabase).
